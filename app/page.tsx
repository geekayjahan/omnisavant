...
import { Target, Zap, Shield, TrendingUp, Brain, Lock, FileText } from 'lucide-react';
...
export default function Dashboard() {
  const [activeView, setActiveView] = useState<'overview' | 'moats' | 'strategies' | 'companies' | 'moat-analysis'>('overview');
